        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Construct = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyRounds", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsentEvents_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guardianships_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RespondentUserId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responses_SurveyRounds_RoundId",
                        column: x => x.RoundId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answers_ItemId",
                table: "Answers",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Answers_ResponseId_ItemId",
                table: "Answers",
                columns: new[] { "ResponseId", "ItemId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoachTeams_CoachUserId_TeamId",
                table: "CoachTeams",
                columns: new[] { "CoachUserId", "TeamId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsentEvents_PlayerId_OccurredAt",
                table: "ConsentEvents",
                columns: new[] { "PlayerId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Guardianships_PlayerId_GuardianUserId",
                table: "Guardianships",
                columns: new[] { "PlayerId", "GuardianUserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Responses_RoundId_PlayerId_RespondentUserId",
                table: "Responses",
